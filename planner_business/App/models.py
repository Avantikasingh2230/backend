...
def gst_attachment(instance, filename):
...
class User(AbstractUser):
    ...
    legal_entity_name = models.CharField(max_length=500, default=False)
    complete_address = models.CharField(max_length=700, default=False)
    ...
    gst_attachment = models.FileField(upload_to=gst_attachment, null=True, blank=True)
