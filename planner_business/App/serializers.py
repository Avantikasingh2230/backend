...
class VendorRegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('full_name', 'occupation', 'mobile', 'email', 'password', 'vendor_type',
            'name_of_business',
            'Owner_name',
            'location','aadhar_no', 'aadhar_attachment', 'pan_no','legal_entity_name',
                          'complete_address', 'pan_attachment', 'gst_no', 'gst_attachment')
    ...
    def create(self, validated_data):
        user = User.objects.create(
         ...
         complete_address = validated_data.get('complete_address'),
         pan_attachment = validated_data.get('pan_attachment'),
         gst_no = validated_data.get('gst_no'),

        gst_attachment = validated_data.get('gst_attachment')
...
class vendortypeSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        user = User(vendor_type=vendor_type, name_of_business=name_of_business, Owner_name=Owner_name,
                          location=location)
...
class vendorInfoSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        user = User(aadhar_no=aadhar_no, aadhar_attachment=aadhar_attachment, pan_no=pan_no,legal_entity_name=legal_entity_name,
                          complete_address=complete_address, pan_attachment=pan_attachment, gst_no=gst_no, gst_attachment=gst_attachment)
