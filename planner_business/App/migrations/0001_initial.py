# Generated by Django 3.2.16 on 2023-01-26 12:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('occupation', models.CharField(choices=[('owner', 'owner'), ('manager', 'manager')], max_length=15)),
                ...
                ('aadhar_attachment', models.FileField(blank=True, null=True, upload_to=App.models.aadhar_attachment)),
                ('legal_entity_name', models.CharField(default=False, max_length=500)),
                ('complete_address', models.CharField(default=False, max_length=700)),
                ('pan_no', models.CharField(blank=True, max_length=50, null=True)),
                ('pan_attachment', models.FileField(blank=True, null=True, upload_to=App.models.pan_attachment)),
                ('gst_no', models.CharField(blank=True, max_length=100, null=True)),
                ('gst_attachment', models.FileField(blank=True, null=True, upload_to=App.models.gst_attachment)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.Permission', verbose_name='user permissions')),
                ('user_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='App.usertype')),
            ],
        ),
        migrations.CreateModel(
            name='weddingmakeup',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(default=True, max_length=500)),
